...
The `lineage/` directory preserves historical material from the Codex Alpha work that preceded EC-64.

These artifacts document an earlier stage of the design in which symbolic encoding of ordinary language was already explicit — the conceptual lineage of this protocol.

See [`lineage/README.md`](lineage/README.md) for the index and transcription policy.
